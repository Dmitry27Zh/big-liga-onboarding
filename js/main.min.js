...
var CONTENT_TOGGLING_DURATION = 800;
var isContentToggling = false;
...
var documentKeydownHandler = function documentKeydownHandler(evt) {
  if (evt.key === 'Enter') {
    initContent();
  }
};

var documentFirstClickHandler = function documentFirstClickHandler(evt) {
  evt.preventDefault();
